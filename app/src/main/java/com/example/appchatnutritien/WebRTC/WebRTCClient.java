package com.example.appchatnutritien.WebRTC;
...
public class WebRTCClient {
    ...
    private void initPeerConnectionFactory(){
        ...
        PeerConnectionFactory.initialize(options);//pass options as a parametre
    }
    ...
    //initializing ui like surface view renderes
